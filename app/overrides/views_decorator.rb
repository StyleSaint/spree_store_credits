...
Deface::Override.new(
  ...
  :text => "<br /><%= link_to_with_icon('add', t('add_store_credit'), new_admin_user_store_credit_url(user)) %><br /><%= link_to_with_icon('add', t('show_store_credits_history'), history_admin_store_credit_path(user)) %>",
  :disabled => false)
